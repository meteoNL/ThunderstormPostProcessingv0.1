library(dplyr)
new_Obs = read.csv("Dataset_06z_predictors.csv")
...
graupelindex = seq(52,59)
cloudiceindex = seq(76,83)
cloudwaterindex = seq(84,91)
rainindex = seq(92,99)
snowindex = seq(100,107)
moistureconverindex = seq(476,483)
...
selected_predictors = c(seq(2,5),11,12,seq(20,length(new_Obs)))
...
write.csv(new_Obs, "Testdata_06z.csv")
