...
for(L in seq(0.5,6.5)*6){
  ...
  for(i in seq(0,6)){
    ...
    fn1 = sprintf("THUNFC/HA40_N25_THUNFC_201504160000_0%02d00_GB",i)
    ...
    for(j in seq(1,46)){
      fn2 = sprintf("GWI/HA40_GWI_20150416000000_%02d00_GB",i)
      #print(getwd())
  ...
  cloud_base_vector = c()
  print(c(quantilesperregion$Cloud_base_q0.10))
  print(t(matrix(c(quantilesperregion$Cloud_base_q0.10, quantilesperregion$Cloud_base_median, quantilesperregion$Cloud_base_q0.90),ncol=3,nrow=13)))
  ...
  quantilesperregion = cbind(centre_time = L+3, quantilesperregion)
